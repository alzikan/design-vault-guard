...
const translations = {
  en: {
    ...
    'admin.tab.art': 'Art',
    'admin.tab.lesson': 'Lesson',
    'admin.tab.video': 'Video',
    'admin.tab.artist': 'Artist',
  ...
  ar: {
    ...
    'admin.tab.art': 'فني',
    'admin.tab.lesson': 'درس',
    'admin.tab.video': 'فيديو',
    'admin.tab.artist': 'الفنان',
    'admin.tab.users': 'مستخدمون',
